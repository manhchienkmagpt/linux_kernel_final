...
GtkWidget *ui_help_page_new(AppContext *ctx) {
    ...
    const char *guide =
        ...
        "1. Build Module\n"
        "2. Load Module\n"
        "3. Plug or rebind a USB HID mouse\n"
        "4. Move/click the mouse\n"
        "5. Refresh Mouse Status\n"
        "6. View Event Log\n"
        "7. Unload Module\n\n"
        "Linux commands:\n"
        "make\n"
        ...
        "If usbhid already owns the mouse:\n"
        ...
        "Replace 1-2:1.0 with the real interface id.\n\n"
        "Notes:\n"
        "- dx/dy are relative movement deltas, not absolute screen coordinates.\n"
        "- This module registers a USB HID boot mouse driver.\n"
        "- If usbhid already owns the mouse, demo may require unbind/bind.\n"
