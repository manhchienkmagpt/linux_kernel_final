...
- Network Info: chon interface va xem IPv4, MAC, state, download/upload speed, RX/TX total theo thoi gian thuc.
...
- `network_manager.c`: liet ke interface, connection viewer va traffic monitor.
